<template>
  ...
  <div class="bdy">
    ...
    <section class="section">
      <div class="top-image">
        <!-- <img class="userimg" src="../assets/23bet.png" alt="Italian Trulli"> -->
        <div class="left-banner">

        </div>
        <div class="adr">
          <h1>Get 200% Bonus When You Deposit 200 And Above</h1>
    ...
    <div class="row">
      <div class="col-12 col-lg-2 col-md-0 col-sm-0 ty is-hidden-mobile">
        <div class="lili">
          <ul>
            <li>Hide</li>
            <li>Football</li>
      ...
      <div class="col-12 col-lg-7 col-md-8 col-sm-8 ty">
        ...
        <div class="gms">
          ...
          <section class="section">
                  ...
                  <div class="corousel1">
                            <img class="userimg" src="../assets/Sports.gif" alt="Italian Trulli">

                    <!-- <img :src="../assets/Sports.gif" :alt="slide.alt" /> -->
                  </div>
            ...
            <div class="whole" v-for="(game, index) in games" :key="index">
              ...
              <div class="bothgamesandodds">
                <div class="homeaway">
                  ...
                  <div class="away">{{ game.fields.away_team }}</div>
                </div>
                <div class='prebet'>

                  <span><button :id="game.fields.home_team + game.fields.home_odd" class="hom"
                      @click="addToBetslip1(game, 'home_odd')">{{ game.fields.home_odd }}</button></span>
                  <span><button :id="game.fields.neutral_odd" class="hom1" @click="addToBetslip1(game, 'neutral_odd')">{{
                    game.fields.neutral_odd }}</button></span>
                  <span> <button :id="game.fields.away_team + game.fields.away_odd" class="hom2"
                      @click="addToBetslip1(game, 'away_odd')">{{ game.fields.away_odd }}</button></span>
                </div>
              </div>
              ...
              <div class="whole">
                ...
                <div class="bothgamesandodds">
                  ...
                  <div class='prebet'>
                    ...
                    <span> <button :id="'button_home_' + item.game_id" class="hom"
                        @click="addToBetslip(item, 'home_odd', index)">{{ item.home_odd }}</button>
                    </span>
                    <span><button :id="'button_neutral_' + item.game_id" class="hom1"
                        @click="addToBetslip(item, 'neutral_odd', index)">{{ item.neutral_odd }}</button></span>
                    <span> <button :id="'button_away_' + item.game_id" class="hom2"
                        @click="addToBetslip(item, 'away_odd', index)">{{ item.away_odd }}</button></span>
                  </div>
                </div>
                <div class="">
                  <div class='preebet'>
...
@media screen and (min-width: 992px) {
  ...
  .left-banner{
    background-image: url('../assets/jackpot-promo-left.png');
